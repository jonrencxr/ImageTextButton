...
typedef NS_ENUM(NSInteger, CRButtonTitleWithImageAlignment) {
    ...
    CRButtonTitleWithImageAlignmentRightBothSide = 4,  //图片在右，图片标题两侧对齐
    CRButtonTitleWithImageAlignmentRightSide = 5,      //图片在最右侧
    CRButtonTitleWithImageAlignmentUpBothLeft = 6,     //图片在上，标题在下。二者左对齐
    CRButtonTitleWithImageAlignmentUpBothRight = 7,    //图片在上，标题在下。二者右对齐
    CRButtonTitleWithImageAlignmentDownBothLeft = 8,   //图片在下，标题在上。二者左对齐
    CRButtonTitleWithImageAlignmentDownBothRight = 9,  //图片在下，标题在上。二者右对齐
};
