...
- (void)alignmentValueChanged {
    ...
    else if (_buttonTitleWithImageAlignment == CRButtonTitleWithImageAlignmentUpBothLeft) {
        interval = (buttonHeight-(imgHeight+_imgTextDistance+textHeight))/2;
        imgOffsetY = interval;
        titleOffsetX = -imgWidth;
        titleOffsetY = interval+imgHeight+_imgTextDistance;
    }
    else if (_buttonTitleWithImageAlignment == CRButtonTitleWithImageAlignmentUpBothRight) {
        interval = (buttonHeight-(imgHeight+_imgTextDistance+textHeight))/2;
        imgOffsetX = buttonWidth-imgWidth;
        imgOffsetY = interval;
        titleOffsetX = buttonWidth-imgWidth-textWitdh;
        titleOffsetY = interval+imgHeight+_imgTextDistance;
    }
    else if (_buttonTitleWithImageAlignment == CRButtonTitleWithImageAlignmentDownBothLeft) {
        interval = (buttonHeight-(imgHeight+_imgTextDistance+textHeight))/2;
        imgOffsetY = interval+_imgTextDistance+textHeight;
        titleOffsetX = -imgWidth;
        titleOffsetY = interval;
    }
    else if (_buttonTitleWithImageAlignment == CRButtonTitleWithImageAlignmentDownBothRight) {
        interval = (buttonHeight-(imgHeight+_imgTextDistance+textHeight))/2;
        imgOffsetX = buttonWidth-imgWidth;
        imgOffsetY = interval+textHeight+_imgTextDistance;
        titleOffsetX = buttonWidth-imgWidth-textWitdh;
